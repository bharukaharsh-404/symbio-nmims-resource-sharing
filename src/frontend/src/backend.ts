...
export class Backend implements backendInterface {
    ...
    async bookStudyRoom(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.bookStudyRoom(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async claimBorrowItem(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.claimBorrowItem(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async claimFoodAlert(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.claimFoodAlert(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAllBorrowItems(): Promise<Array<BorrowItem>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllBorrowItems();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAllFoodAlerts(): Promise<Array<FoodAlert>> {
        if (this.processError) {
            try {
    ...
    async getAllStudyRooms(): Promise<Array<StudyRoom>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllStudyRooms();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
